...
def process_traces_vectorized(trxs, test_trxs, delta, operation):
    ...
    if operation == 'SUM':
        ...
        new_trxs_test = test_T1 / (test_T2 + epsilon)
    elif operation == 'SUB':
        new_trxs = train_T1 - train_T2
        new_trxs_test = test_T1 - test_T2
    else:
